...
public class PlanarReflections : MonoBehaviour
{
    ...
    public void ExecuteBeforeCameraRender(ScriptableRenderContext context, Camera camera)
    {
        ...
        // UnityEngine.Rendering.Universal.UniversalRenderPipeline.SubmitRenderRequest<Camera>(camera, m_ReflectionCamera);
        ...
        if (m_settings._blurOn)
        {
            ...
            buf.SetGlobalFloat("_BlurOffset", 0.5f + m_settings._blurSize);
